...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job1->setPresentation('Je cherche une animatrice ou bien animateur pour animer l\'anniversaire de mon fils Leon et de ses amis.');
        ...
        $job2->setPresentation('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
